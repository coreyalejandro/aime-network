              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-800">Ask the Fashionista</span>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
                    ...
                    {conversationHistory.slice(-3).map((message, index) => (
                      <div key={index} className="space-y-1">
                        ...
                        <div className="text-sm text-purple-800 bg-purple-50 p-2 rounded">
                          Fashionista: {message.fashionista}
                        </div>
                      </div>
                    ))}
                    {isProcessing && (
